<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl">Edit Workout Template</h2>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow p-6">
                ...
                <form method="POST" action="{{ route('admin.workouts.update', $item) }}" class="space-y-4">
                    @csrf
                    @method('PUT')
