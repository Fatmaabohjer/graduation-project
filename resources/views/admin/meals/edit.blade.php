<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl">Edit Meal Template</h2>
            ...
            <div class="bg-white rounded-xl shadow p-6">
                ...
                <form method="POST" action="{{ route('admin.meals.update', $item) }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input name="meal_type" value="{{ old('meal_type', $item->meal_type) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="calories" value="{{ old('calories', $item->calories) }}"
